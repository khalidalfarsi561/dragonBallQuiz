...
export default async function SeriesPage() {
  ...
  return (
    <main className="relative mx-auto w-full max-w-6xl overflow-hidden px-4 pt-8 pb-12 sm:px-6 sm:pt-10 sm:pb-16 lg:px-8">
      ...
      <div className="mb-6 h-px w-full bg-linear-to-r from-transparent via-white/15 to-transparent" />
